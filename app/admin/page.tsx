...
function AdminStudentBrochureItem({ student, formConfig, getCustomFieldsForSection }: { student: any; formConfig: any; getCustomFieldsForSection: any }) {
        ...
        <div className="brochure-card">
          ...
          <div className={densityClass} ref={bodyRef} style={dynamicHeight ? { height: `${dynamicHeight}px`, minHeight: 'auto' } : undefined}>
            <div className="section contact-section">
              ...
              {getCustomFieldsForSection('contact', student).map((cf: any, idx: number) => (
              ...
              {getCustomFieldsForSection('personal', student).map((cf: any, idx: number) => (
            ...
            <div className="section">
              ...
              {getCustomFieldsForSection('education', student).length > 0 && (
                <ul className="bullet-list" style={{ marginTop: '0.5rem' }}>
                  {getCustomFieldsForSection('education', student).map((cf: any, idx: number) => (
            ...
            {(certs.length > 0 || getCustomFieldsForSection('certifications', student).length > 0) && (
              <div className="section">
                ...
                <ul className="bullet-list">
                  ...
                  {getCustomFieldsForSection('certifications', student).map((cf: any, idx: number) => (
            ...
            {(internships.length > 0 || getCustomFieldsForSection('internships', student).length > 0) && (
              <div className="section">
                ...
                <ul className="bullet-list">
                  ...
                  {getCustomFieldsForSection('internships', student).map((cf: any, idx: number) => (
            ...
            {(projs.length > 0 || getCustomFieldsForSection('projects', student).length > 0) && (
              <div className="section">
                ...
                <ul className="bullet-list">
                  ...
                  {getCustomFieldsForSection('projects', student).map((cf: any, idx: number) => (
                    <li key={'cf_' + idx} className="item-sub" style={{ color: '#113666' }}>
                      <strong>{cf.label}:</strong> {renderWithLinks(typeof cf.value === 'object' ? JSON.stringify(cf.value) : String(cf.value))}
                    </li>
                  ))}
            ...
            {(tech.length > 0 || getCustomFieldsForSection('technical', student).length > 0) && (
              <div className="section">
                ...
                <ul className="bullet-list">
                  ...
                  {getCustomFieldsForSection('technical', student).map((cf: any, idx: number) => (
                    <li key={'cf_' + idx}><strong>{cf.label}:</strong> {renderWithLinks(typeof cf.value === 'object' ? JSON.stringify(cf.value) : String(cf.value))}</li>
                  ))}
                </ul>
              </div>
            ...
            {(strengths.length > 0 || getCustomFieldsForSection('strengths', student).length > 0) && (
              <div className="section">
                ...
                <ul className="bullet-list strengths-list">
                  ...
                  {getCustomFieldsForSection('strengths', student).map((cf: any, idx: number) => (
                    <li key={'cf_' + idx}><strong>{cf.label}:</strong> {renderWithLinks(typeof cf.value === 'object' ? JSON.stringify(cf.value) : String(cf.value))}</li>
                  ))}
                </ul>
              </div>
              ...
              .map((secId: string) => {
                ...
                return (
                  <div key={secId} className="section">
                    <h3>{secTitle}</h3>
                    <ul className="bullet-list">
                      {secFields.map((cf: any, idx: number) => (
                        <li key={idx}>
                          <strong>{cf.label}:</strong> {renderWithLinks(typeof cf.value === 'object' ? JSON.stringify(cf.value) : String(cf.value))}
                        </li>
                      ))}
...
function AdminDashboardContent() {
  ...
  const STANDARD_FIELD_DEFS = [
    ...
    { id: 'objective', defaultLabel: 'Vision Statement (2 Lines)', defaultType: 'textarea', stateKey: 'showObjective', defaultSec: 'personal' },
    ...
    { id: 'linkedIn', defaultLabel: 'LinkedIn', defaultType: 'text', stateKey: 'showLinkedIn', defaultSec: 'contact' },
    { id: 'github', defaultLabel: 'GitHub', defaultType: 'text', stateKey: 'showGithub', defaultSec: 'contact' },
    { id: 'portfolio', defaultLabel: 'Portfolio', defaultType: 'text', stateKey: 'showPortfolio', defaultSec: 'contact' },
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem', alignItems: 'center' }}>
          {approvedStudents.length === 0 ? (
            ...
            approvedStudents.map(student => (
              <AdminStudentBrochureItem 
                key={student.id} 
                student={student} 
                formConfig={formConfig} 
                getCustomFieldsForSection={getCustomFieldsForSection} 
              />
            ))
          )}
        </div>
